...
export function NewTemplateForm() {
  ...
  function getDefaultTemplate(type: "html" | "react" | "tailwind") {
    switch (type) {
      case "react":
        return `
...
`
  ...
  const sendTestEmail = async () => {
    ...
    try {
      ...
      formData.append("from", "test@linksus.in")
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("Submitting template with attachments:", template.attachments)
      ...
      showConfirmation("Template Created", "Your template has been created successfully.")

      router.push("/templates")
    } catch (error) {
      console.error("Error creating template:", error)
      showConfirmation("Error", "Failed to create template. Please try again.", "destructive")
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleGenerateWithAI = async () => {
    ...
    try {
      ...
      if (data.variables && data.variables.length > 0) {
        const newVariables = data.variables.filter((v) => !template.variables.includes(v))
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Enter the basic information for your email template</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="border-b p-4 bg-muted/20">
                <div className="space-y-2">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-80">
                          <p className="text-xs">
                            Describe the email template you want to create (e.g., "Create a job recommendation email
                            template"). The AI will generate content based on your description.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  ...
                  <div className="flex gap-2">
                    <Input
                      id="ai-prompt"
                      placeholder="E.g., Create a welcome email for new customers..."
                      value={aiPrompt}
                  ...
                  <p className="text-xs text-muted-foreground">
                    The AI will generate a template based on your prompt and the selected template type (
                    {template.templateType === "html"
                      ? "HTML"
                      : template.templateType === "react"
                        ? "React JSX"
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <Button onClick={handleSubmit} disabled={loading} className="w-full" aria-label="Create template">
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input id="test-email-from" value="test@linksus.in" disabled />
            </div>
            <div className="space-y-2">
