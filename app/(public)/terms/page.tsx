...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for AiMailer email management platform",
}
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          of AiMailer, Inc. and its licensors. The Service is protected by copyright, trademark, and other laws of both
          the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any
          product or service without the prior written consent of AiMailer, Inc.
        </p>
