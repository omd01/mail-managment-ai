...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for AiMailer open source email management platform",
}
      ...
      <div className="prose dark:prose-invert max-w-none">
        <div className="p-4 border rounded-lg bg-muted/20 mb-6">
          ...
          <p className="text-sm mb-0">
            AiMailer is open source software. This Privacy Policy applies to the hosted version of AiMailer provided by
            AiMailer, Inc. If you're self-hosting the software, you are the data controller and responsible for your own
            privacy policy and data handling practices. The following policy outlines our practices for the hosted
            service.
          </p>
        </div>
        ...
        <p>If you choose to self-host the AiMailer software:</p>
        <ul>
          <li>You become the data controller for any data processed by your instance of the software</li>
          <li>You are responsible for complying with applicable data protection laws</li>
          <li>You should create your own privacy policy that reflects your data handling practices</li>
          <li>We do not have access to data processed by self-hosted instances</li>
          <li>You are responsible for implementing appropriate security measures to protect user data</li>
        </ul>
